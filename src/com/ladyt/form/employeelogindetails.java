 ...
 * @author Lady T
 */
public class employeelogindetails extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "SN", "EMPLOYEE ID", "PASSWORD", "STATUS"
            }
        ) {
    ...
    private void view() {
        ...
        String[] ColumnName = {"SN","EMPLOYEE ID", "PASSWORD","STATUS"};
                   
       String[][] data;
        int Total = 0;
        String viewAllCont = "Select * from employeelogindetails;";
        try {
            ...
            if (Total != 0) {
                while (result.next()) {
                    ...
                    data[i][2] = result.getString("password");
                    data[i][3] = result.getString("status");
