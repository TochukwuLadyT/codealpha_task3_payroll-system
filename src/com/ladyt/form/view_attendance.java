...
public class view_attendance extends javax.swing.JPanel {
    ...
    // End of variables declaration//GEN-END:variables
     ...
     private void view() {
        ...
        String[] ColumnName = {"SN","EMPLOYEE ID", "FULL NAME", "EMPLOYEE EMAIL","STATUS", "ATTENDANCE DATE"};
                   
       String[][] data;
        int Total = 0;
        String viewAllCont = "Select * from attendance;";
        try {
            ...
            if (Total != 0) {
                while (result.next()) {
                    ...
                    data[i][3] = result.getString("employeeEmail");
                    data[i][4] = result.getString("status");
                    data[i][5] = result.getString("attendance_date");
